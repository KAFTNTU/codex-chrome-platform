...
TOOLS = [
    ...
    {"name":"chrome_bridge_elementor_run_workflow","description":"Run up to 60 verified Elementor steps, optionally roll back mutations on failure, preview, and save only with explicit confirmation.","inputSchema":{"type":"object","properties":{"steps":{"type":"array","items":{"type":"object","properties":{"action":{"type":"string"},"operation":{"type":"string"},"params":{"type":"object","additionalProperties":True}},"additionalProperties":False}},"stopOnError":{"type":"boolean"},"rollbackOnError":{"type":"boolean"},"previewAfter":{"type":"boolean"},"saveMode":{"type":"string","enum":["draft","update","publish"]},"confirmSave":{"type":"boolean"},"waitMs":{"type":"integer"},"tabId":{"type":"integer"}},"required":["steps"],"additionalProperties":False}},
